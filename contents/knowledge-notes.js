...
function initOverlayMenu() {
  const overlay = document.getElementById("kn-menu-overlay");
  const toggleBtn = document.getElementById("kn-menu-toggle");
  const closeBtn = document.getElementById("kn-menu-close");
