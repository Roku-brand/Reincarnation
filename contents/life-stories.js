...
function initOverlayMenuLS() {
  const overlay = document.getElementById("ls-menu-overlay");
  const toggleBtn = document.getElementById("ls-menu-toggle");
  const closeBtn = document.getElementById("ls-menu-close");
